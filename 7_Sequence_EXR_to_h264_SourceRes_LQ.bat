...
mkdir "_OUT"
set out=_OUT\%base_name_no_number%_LQ.mp4
...
"%FFMPEG%" ^
    ...
    -c:a aac -b:a 128k ^
    -vf "scale=out_color_matrix=bt709:out_range=tv, lut3d=file='!LUT!', colorspace=all=bt709:iall=bt709:itrc=bt709" ^
    -c:v libx264 -pix_fmt yuv420p -crf 23 -bsf:v h264_metadata=video_full_range_flag=0:colour_primaries=1:transfer_characteristics=1:matrix_coefficients=1 ^
